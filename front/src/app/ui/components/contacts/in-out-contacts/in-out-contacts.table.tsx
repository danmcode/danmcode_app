...
export default function InOutContactsTable(props: TableProps) {
                        ...
                        {data.map((item) => (
                            ...
                            >
                                ...
                                <td className="email align-middle white-space-nowrap">
                                    {`${item.contact.location} - ${item.contact.privateUnit}`}
                                </td>

                                <td className="mobile_number align-middle white-space-nowrap">
                                    {`${item.dateIn.toLocaleDateString('es-ES', {
                                        year: 'numeric',
                                        month: 'long',
                                        day: 'numeric'
                                    })} ${item.dateIn.toLocaleTimeString('es-ES', {
                                        hour: '2-digit',
                                        minute: '2-digit',
                                        second: '2-digit'
                                    })}`}
                                ...
                                <td className="city align-middle white-space-nowrap text-body">
                                    {`${item.dateOut.toLocaleDateString('es-ES', {
                                        year: 'numeric',
                                        month: 'long',
                                        day: 'numeric'
                                    })} ${item.dateOut.toLocaleTimeString('es-ES', {
                                        hour: '2-digit',
                                        minute: '2-digit',
                                        second: '2-digit'
                                    })}`}
